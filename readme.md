...
iBoxMan 软件专为苹果设备设计，支持最新的iOS和macOS系统，兼容多种接收设备，包括智能电视、投影仪及支持AirPlay 2的设备。通过无线网络，iBox 实现了设备间的快速连接和高质量屏幕共享。

## 安装指南

1. **下载安装：** 访问 苹果应用商店，搜索“iBoxMan”并下载安装到您的苹果设备上。
2. **连接设备：** 确保您的苹果设备和接收设备处于同一WiFi网络下。
3. **启动软件：** 打开 iBoxMan 应用，按照应用内提示完成设备连接和配置。

## 使用教程

### 基本使用：

1. 在您的苹果设备上打开 iBoxMan 应用。
2. 选择您希望投屏的接收设备。
